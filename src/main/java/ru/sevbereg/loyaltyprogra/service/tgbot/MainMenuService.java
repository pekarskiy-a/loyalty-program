...
public class MainMenuService {
    ...
    private ReplyKeyboardMarkup getMainMenuKeyboard() {
        KeyboardButton cardInfo = KeyboardButton.builder().text(localeMessageService.getMessage("button.menu.card.info")).build();
        KeyboardRow row1 = new KeyboardRow();
        row1.add(cardInfo);

        KeyboardButton lpInfo = KeyboardButton.builder().text(localeMessageService.getMessage("button.menu.lp.info")).build();
