...
@Slf4j
@Component
public class WriteOffBalanceMessageHandler extends UpdateBalanceMessageHandler {


    public WriteOffBalanceMessageHandler(UserBotStateService botStateService,
    ...
    public BotState getHandlerName() {
        return BotState.WRITE_OFF_BALANCE;
    }
